...
import 'package:egyptm/app/models/cart_model.dart';
...
class CartService{
  ...
  static Future<String?> webCheckout({int? discountId})async{
    try{
      String url = '${Constants.baseUrl}panel/cart/web_checkout';

      var body = discountId != null ?{
  ...
  static Future<CheckoutModel?> checkout({int? discountId})async{
    try{
