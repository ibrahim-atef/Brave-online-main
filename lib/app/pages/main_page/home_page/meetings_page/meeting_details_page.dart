...
import 'package:egyptm/app/widgets/main_widget/meetings_widget/meetings_widget.dart';
                    ...
                    if((details?.meeting?.meetingType ?? '') != 'in_person')...{
                      Expanded(
                        child: button(
                          ...
                          bgColor: (details?.meeting?.status == 'pending' && isConsultant) || details?.meeting?.status == 'open' ? mainColor() : greyCF,
