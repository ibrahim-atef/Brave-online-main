...
import 'package:egyptm/app/services/user_service/personal_note_service.dart';
...
class _SingleContentPageState extends State<SingleContentPage> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((timeStamp) {
      ...
      Future.wait([getData(), getPreviousData(), getNote()]).then((value) {
        ...
        print(singleContentData?.toJson().toString());
        print("singleContentData");
      });
    });
  }
  ...
  @override
  void dispose() {
    // استعادة إعدادات الـ system UI عند الخروج من صفحة الفيديو
                      ...
                      children: [
                        ...
                        if (isDripContent) ...{
                          ...
                          if ((singleContentData?.storage == 'upload' ||
                              ...
                              videoFormats.contains(singleContentData?.fileType
                                  ?.toLowerCase())) ...{
                            space(20),
                            CourseVideoPlayer(
                          ...
                          if (singleContentData?.storage == 'vimeo' ||
                              singleContentData?.storage == 'youtube') ...{
                            PodVideoPlayerDev(
                              singleContentData?.file ?? '',
                              singleContentData?.storage ?? '',
                              Constants.contentRouteObserver,
                        ...
                        if (PublicData.apiConfigData?['course_notes_status'] ==
                            '1') ...{
                          // add note
                          Row(
                            children: [
                          ...
                          SizedBox(
                            ...
                            child: SingleChildScrollView(
                              ...
                              child: Row(
                                children: [
                                  ...List.generate(
                                      singleContentData?.attachments?.length ??
                                          0, (index) {
                        ...
                        child: button(
                            onTap: () {
                              ...
                              if (singleContentData?.fileType == 'pdf') {
                                // Navigator.push(context, MaterialPageRoute(builder: (builder)=> PdfViewerAndDownloader(pdfURL: "https://abdulrahman.anmka.com/store/1050/Assignment 2 - General Chemistry 1 - CHM1101.pdf",)));
