                  ...
                  children: [
                    ...
                    if(isDripContent)...{
                      ...
                      if( (singleContentData?.storage == 'upload' || singleContentData?.storage == 'external_link' || singleContentData?.storage == 's3') && videoFormats.contains(singleContentData?.fileType?.toLowerCase()) )...{
                        ...
                        CourseVideoPlayer(singleContentData?.file ?? '', '', Constants.contentRouteObserver, name: name,),
                      },
                      ...
                      if( singleContentData?.storage == 'vimeo' || singleContentData?.storage == 'youtube' )...{
                        ...
                        PodVideoPlayerDev(
                          ...
                          Constants.contentRouteObserver, name: name,
                        )
                      },
              ...
              children: [
                ...
                Expanded(
                  child: button(
                    ...
                    height: 52,
                    text: appText.join,
                    bgColor: (singleContentData?.isFinished ?? false) ? greyCF.withOpacity(.8) : mainColor(),
                    textColor: Colors.white
                  )
                ),
                ...
                Expanded(
                  child: button(
                    ...
                    bgColor: Colors.white,
                    textColor: (singleContentData?.isFinished ?? false) ? greyCF : mainColor(),
                    borderColor: (singleContentData?.isFinished ?? false) ? greyCF.withOpacity(.8) : mainColor(),
