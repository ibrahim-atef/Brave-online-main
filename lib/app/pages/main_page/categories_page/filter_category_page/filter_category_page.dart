...
import 'package:egyptm/app/pages/main_page/categories_page/filter_category_page/dynamiclly_filter.dart';
import 'package:egyptm/app/pages/main_page/categories_page/filter_category_page/options_filter.dart';
...
import 'package:egyptm/common/utils/tablet_detector.dart';
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  //     bgColor: Colors.transparent, 
                  //     textColor: filters.isEmpty ? mainColor().withOpacity(.35) : mainColor(),
                  //     borderColor: filters.isEmpty ? mainColor().withOpacity(.35) : mainColor(),
                  //     iconColor: filters.isEmpty ? mainColor().withOpacity(.35) : mainColor(),
