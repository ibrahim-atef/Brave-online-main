...
import 'package:egyptm/app/pages/main_page/blog_page/blogs_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/certificates_page/certificates_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/assignments_page/assignments_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/financial_page/financial_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/meetings_page/meetings_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/setting_page/setting_page.dart';
import 'package:egyptm/app/providers/app_language_provider.dart';
import 'package:egyptm/app/providers/page_provider.dart';
...
import '../../pages/main_page/ai_page/ai_page.dart';
import '../../pages/main_page/home_page/chat_screen/chat_screen.dart';
...
class _MainDrawerState extends State<MainDrawer> {
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ? Container(
                                      ...
                                      child: Image.asset(AppAssets.appLogoPng,fit:BoxFit.cover ,)
                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(
                        children: [
                          ...
                          // if(token.isNotEmpty)
                          // menuItem(appText.logOut, AppAssets.dashboardSvg, ()async{
                          //
                          //   drawerController.hideDrawer();
                          //
                          //   // logout
                          ...
                          //
                          // if(token.isEmpty)
                          //   menuItem(appText.login, AppAssets.dashboardSvg, ()async{
                          //
                          //     // login
                          //     AppData.saveAccessToken('');
                          ...
                          // menuItem(appText.blog, AppAssets.blogSvg, (){
                          //   if(hasAccess(canRedirect: true)){
                          //     nextRoute(BlogsPage.pageName);
                          //   }
                          // }),
                          ...
                          menuItem(appText.enrollment, AppAssets.supportSvg, (){
                            if(hasAccess(canRedirect: true)){
                          ...
                          // menuItem(isPng: true, appText.chat, AppAssets.chatIconPng, (){
                          //   if(hasAccess(canRedirect: true)){
                          //     nextRoute(ChatScreen.pageName);
                          //   }
                          // }),



                          menuItem(isPng: true, appText.gpt, AppAssets.chatIconPng, (){
                            if(hasAccess(canRedirect: true)){
                              nextRoute(AiPage.pageName);
                            }
                          }),
  ...
  Widget menuItem(String name,String iconPath,Function onTap, {bool isPng=false}){
    return Container(
      width: getSize().width,
