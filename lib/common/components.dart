...
import 'package:egyptm/app/pages/main_page/home_page/cart_page/cart_page.dart';
import 'package:egyptm/app/pages/main_page/home_page/single_course_page/forum_page/forum_answer_page.dart';
...
import 'package:egyptm/app/services/user_service/forum_service.dart';
...
Widget courseItem(CourseModel courseData,{bool isSmallSize=true,double width = 178.0,height = 200.0,double endCardPadding=16.0, bool isShowReward=false}){
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      //           child: SvgPicture.asset(AppAssets.notificationSvg,colorFilter: ColorFilter.mode(mainColor(), BlendMode.srcIn),width: 12,),
                      //         )
                      //       ),
                      //     }
                      //   ],
  ...
  return GestureDetector(
    ...
    child: Row(
      ...
      children: [
        ...
        Text(
          title,
          style: style14Regular().copyWith(color: grey33),
        ),
                    ...
                    child: Container(
                      ...
                      child: Stack(
                        children: [
                          ...
                          Align(
                            alignment: Alignment.center,
                            child: SvgPicture.asset(AppAssets.basketSvg,colorFilter: ColorFilter.mode(mainColor(), BlendMode.srcIn),),
                          ),
...
Widget dashboardInfoBox(Color color, String icon, String title,
 String subTitle, Function onTap, {double width=140, double height=170, int icWidth=22}){
  return GestureDetector(
    onTap: (){
